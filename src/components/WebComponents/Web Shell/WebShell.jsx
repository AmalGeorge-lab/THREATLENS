...
import { ArrowLeftRight, BadgeAlert, BadgeInfo, Calendar, CircleAlert, Clock, Crosshair, ExternalLink, FileCode, FileDown, Fingerprint, GitBranch, Globe, Link, MonitorSmartphone, ScrollText, SquareTerminal } from "lucide-react";
...
const WebShell = () => {
  ...
  return (
    ...
    <section className="web-shell-section">
          ...
          <>
            <section className="alert-info-section">
              ...
              <div className="left-section">
                <SquareTerminal size={52} style={{ color : "red" }}/>
                <div>
