import "./sqlAttack.css";
import {useMutation, useQuery} from "@tanstack/react-query";
import { webAlertAPI, webUpdateStatusAPI } from "../../../api/alertsAPI";
import {useNavigate,useParams} from "react-router-dom";
import Loading from "../../Loading/Loading";
import { useEffect } from "react";
import { ArrowLeftRight, BadgeAlert, BadgeInfo, Calendar, CircleAlert, Clock, Crosshair, DatabaseZap, ExternalLink, FileCode, FileDown, Fingerprint, GitBranch, Globe, Link, MonitorSmartphone, ScrollText } from "lucide-react";
...
const SQLAttack = () => {
  ...
  return (
    <section className="sql-attack-section">
          ...
          <>
            <section className="alert-info-section">
              ...
              <div className="left-section">
                <DatabaseZap size={52} style={{ color : "red" }}/>
                <div>
