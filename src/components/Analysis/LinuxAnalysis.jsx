...
const LinuxAnalysis = () => {
  ...
  const rulesData = {
    labels: ["AUTH-001", "AUTH-002", "AUTH-003", "AUTH-004"],
    datasets : [{
      data: [ruleValues["AUTH-001"], ruleValues["AUTH-002"], ruleValues["AUTH-003"], ruleValues["AUTH-004"]],
      backgroundColor: ["#c52222","#f86402","#f9f116", "#52ef44"],
      borderRadius: 4,
      barPercentage: 0.7 ,
  ...
  const attackData = {
    labels: [
      ...
      "PASSWORD SPRAYING" ,
      "ROOT ACCOUNT BRUTE FORCE ATTACK" ,
      "ROOT ACCOUNT DISTRIBUTED BRUTE FORCE ATTACK" ,
      "BRUTE FORCE ACCOUNT SUCCESS" ,
      "DISTRIBUTED BRUTE FORCE ACCOUNT SUCCESS" ,
      "ROOT ACCOUNT BRUTE FORCE ATTACK SUCCESS" ,
      "ROOT ACCOUNT DISTRIBUTED ATTACK SUCCESS" ,
      "USERNAME ENUMERATION ATTACK"
    ],
    datasets : [{
      data: [
        attackValues["Classical Brute Force Attack"],
        attackValues["Distributed Brute Force Attack"],
        attackValues["Password Spraying Attack"],
        attackValues["Root Account Brute Force Attack"],
        attackValues["Root Account Distributed Brute Force Attack"],
        attackValues["Brute Force Account Success"],
        attackValues["Distributed Brute Force Attack Success"],
        attackValues["Root Brute Force Account Success"],
        attackValues["Root Account Distributed Brute Force Attack Success"],
        attackValues["Username Enumeration Attack"]
      ],
      backgroundColor: [
        "#cc1515",
        "#f86402",
                ...
                <div>
                  ...
                  <select name="attack" onChange={handleChange} defaultValue={filterData.attack} style={{ width : "400px" }}>
                    ...
                    {[
                      ...
                      "Root Account Distributed Brute Force Attack",
                      "Brute Force Account Success",
                      "Distributed Brute Force Attack Success",
                      "Root Brute Force Account Success",
                      "Root Account Distributed Brute Force Attack Success",
                      "Username Enumeration Attack"
                    ].map((attack)=>{
